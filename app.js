...
function renderAccountView213(){
 ...
 $('accountSignedOut')?.classList.toggle('hidden',!!currentUser);
 $('accountSignedIn')?.classList.toggle('hidden',!currentUser);
 const badge=$('accountViewBadge');if(badge)badge.textContent=currentUser?a.badge:(t().notSigned||'Signed out');
