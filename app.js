...
async function loadIllustration(index,prompt,silent=false,force=false){
 ...
 try{
   ...
   let image=await requestIllustration(key,prompt,`Character continuity only: ${book.character_bible||'Keep the main child character visually consistent across the book.'}`,force,book.child?.referencePhoto||null);
