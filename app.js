...
async function applyAuthSession(session){
 ...
 if(currentUser){
   ...
   await Promise.all([loadCloudProfiles(),loadCastMembers246(),loadCloudStories(),loadStoryCredits()]);
