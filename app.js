...
async function saveCastEditor246(){
 ...
 const kind=castEditor246.kind,name=$('castEditorName').value.trim(),age=Number($('castEditorAge').value),relationship=$('castEditorRelationship').value.trim(),animal=$('castEditorAnimal').value.trim(),breed=$('castEditorBreed')?.value.trim()||'';
 ...
 const payload={parent_id:currentUser.id,kind,name,age:kind==='child'?age:null,relationship:kind==='adult'?relationship:null,animal_type:kind==='pet'?animal:null,breed:kind==='pet'?(breed||null):null};
