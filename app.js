...
const UI139={
'en-GB':{childIntro:'Choose a child from your saved profiles or add a new one.',storyTitle:'What would you like the story to be about?',storyIntro:'Tell Moonbeam your idea, then choose a tone and optionally some values to include.',ideaLabel:'Your story idea',ideaPlaceholder:"Tell Moonbeam anything you'd like to include…",tone:'Story tone',toneHelp:'Choose the mood for your story.',values:'Values to include',generate:'✨ Create Story',savedTitle:'Your Stories',create:'Create Story',saved:'Saved Stories',account:'Account'},
'en-US':{childIntro:'Choose a child from your saved profiles or add a new one.',storyTitle:'What would you like the story to be about?',storyIntro:'Tell Moonbeam your idea, then choose a tone and optionally some values to include.',ideaLabel:'Your story idea',ideaPlaceholder:"Tell Moonbeam anything you'd like to include…",tone:'Story tone',toneHelp:'Choose the mood for your story.',values:'Values to include',generate:'✨ Create Story',savedTitle:'Your Stories',create:'Create Story',saved:'Saved Stories',account:'Account'},
'es-ES':{childIntro:'Elige un perfil infantil guardado o añade uno nuevo.',storyTitle:'¿De qué te gustaría que tratara la historia?',storyIntro:'Cuéntale tu idea a Moonbeam y después elige un tono y, si quieres, algunos valores.',ideaLabel:'Tu idea para la historia',ideaPlaceholder:'Cuéntale a Moonbeam todo lo que te gustaría incluir…',tone:'Tono de la historia',toneHelp:'Elige el ambiente de la historia.',values:'Valores que incluir',generate:'✨ Crear historia',savedTitle:'Tus historias',create:'Crear historia',saved:'Historias guardadas',account:'Cuenta'},
'es-419':{childIntro:'Elige un perfil infantil guardado o agrega uno nuevo.',storyTitle:'¿De qué te gustaría que tratara la historia?',storyIntro:'Cuéntale tu idea a Moonbeam y luego elige un tono y, si quieres, algunos valores.',ideaLabel:'Tu idea para la historia',ideaPlaceholder:'Cuéntale a Moonbeam todo lo que te gustaría incluir…',tone:'Tono de la historia',toneHelp:'Elige el ambiente de la historia.',values:'Valores para incluir',generate:'✨ Crear historia',savedTitle:'Tus historias',create:'Crear historia',saved:'Historias guardadas',account:'Cuenta'},
'fr-FR':{childIntro:'Choisissez un profil enfant enregistré ou ajoutez-en un nouveau.',storyTitle:'De quoi aimeriez-vous que parle l’histoire ?',storyIntro:'Donnez votre idée à Moonbeam, puis choisissez un ton et, si vous le souhaitez, quelques valeurs.',ideaLabel:'Votre idée d’histoire',ideaPlaceholder:'Dites à Moonbeam tout ce que vous aimeriez inclure…',tone:'Ton de l’histoire',toneHelp:'Choisissez l’ambiance de votre histoire.',values:'Valeurs à inclure',generate:'✨ Créer l’histoire',savedTitle:'Vos histoires',create:'Créer une histoire',saved:'Histoires enregistrées',account:'Compte'},
'de-DE':{childIntro:'Wähle ein gespeichertes Kinderprofil oder füge ein neues hinzu.',storyTitle:'Wovon soll die Geschichte handeln?',storyIntro:'Erzähle Moonbeam deine Idee und wähle danach eine Stimmung und optional einige Werte.',ideaLabel:'Deine Geschichtenidee',ideaPlaceholder:'Erzähle Moonbeam alles, was du gern einbauen möchtest…',tone:'Stimmung der Geschichte',toneHelp:'Wähle die Stimmung für deine Geschichte.',values:'Werte, die vorkommen sollen',generate:'✨ Geschichte erstellen',savedTitle:'Deine Geschichten',create:'Geschichte erstellen',saved:'Gespeicherte Geschichten',account:'Konto'},
'it-IT':{childIntro:'Scegli un profilo bambino salvato o aggiungine uno nuovo.',storyTitle:'Di cosa vorresti che parlasse la storia?',storyIntro:'Racconta a Moonbeam la tua idea, poi scegli un tono e, se vuoi, alcuni valori.',ideaLabel:'La tua idea per la storia',ideaPlaceholder:'Racconta a Moonbeam tutto ciò che vorresti includere…',tone:'Tono della storia',toneHelp:'Scegli l’atmosfera della storia.',values:'Valori da includere',generate:'✨ Crea la storia',savedTitle:'Le tue storie',create:'Crea storia',saved:'Storie salvate',account:'Account'},
'pt-BR':{childIntro:'Escolha um perfil infantil salvo ou adicione um novo.',storyTitle:'Sobre o que você gostaria que fosse a história?',storyIntro:'Conte sua ideia à Moonbeam e depois escolha um tom e, se quiser, alguns valores.',ideaLabel:'Sua ideia para a história',ideaPlaceholder:'Conte à Moonbeam tudo o que você gostaria de incluir…',tone:'Tom da história',toneHelp:'Escolha o clima da sua história.',values:'Valores para incluir',generate:'✨ Criar história',savedTitle:'Suas histórias',create:'Criar história',saved:'Histórias salvas',account:'Conta'},
'pl-PL':{childIntro:'Wybierz zapisany profil dziecka lub dodaj nowy.',storyTitle:'O czym ma być ta historia?',storyIntro:'Opowiedz Moonbeam o swoim pomyśle, a potem wybierz ton i opcjonalnie wartości.',ideaLabel:'Twój pomysł na historię',ideaPlaceholder:'Napisz Moonbeam, co chcesz zawrzeć w historii…',tone:'Ton historii',toneHelp:'Wybierz nastrój historii.',values:'Wartości do uwzględnienia',generate:'✨ Utwórz historię',savedTitle:'Twoje historie',create:'Utwórz historię',saved:'Zapisane historie',account:'Konto'}
};
function ui139(){return UI139[language]||UI139['en-GB']}
function updateIdeaCount(){const n=$('ideaCount'),i=$('interests');if(n&&i)n.textContent=String(i.value.length)}
function renderToneChoices(){const host=$('toneChoices'),sel=$('tone');if(!host||!sel)return;const icons=['🍃','😊','⛰️','⭐'];host.innerHTML=[...sel.options].map((o,i)=>`<button type="button" class="tone-choice${o.selected?' active':''}" data-tone="${escapeHtml(o.value)}"><span>${icons[i]||'✦'}</span>${escapeHtml(o.textContent)}</button>`).join('');host.querySelectorAll('[data-tone]').forEach(b=>b.onclick=()=>{sel.value=b.dataset.tone;renderToneChoices()})}
function updateProductNavLocale(){const u=ui139();setText('#navCreate',u.create);setText('#navSaved',u.saved);setText('#navAccount',u.account);document.querySelectorAll('[data-mobile-nav]').forEach(b=>{const k=b.dataset.mobileNav;b.querySelector('span').textContent=k==='create'?u.create:k==='saved'?u.saved:u.account})}
function applyLocale(){
 ...
 setText('#childTitle',x.childTitle); setText('#nameLabel',x.name); if($('name'))$('name').placeholder=x.namePh; setText('#ageLabel',x.age);
 const u=ui139(); setText('.child-intro',u.childIntro); setText('#interestsLabel',u.ideaLabel); if($('interests'))$('interests').placeholder=u.ideaPlaceholder; setText('#storyPrefs',u.storyTitle); setText('.story-intro',u.storyIntro); setText('#toneLabel',u.tone); setText('#valuesTitle',u.values); setText('.option-help',u.toneHelp); setText('#generate',u.generate); if($('savedTitle'))$('savedTitle').textContent=u.savedTitle; renderToneChoices(); updateIdeaCount(); updateProductNavLocale();
...
function showProductSection(which){const savedView=$('savedStoriesView'),shell=$('setupShell');document.body.classList.toggle('product-account-view',which==='account');document.querySelectorAll('.top-tab').forEach(b=>b.classList.remove('active'));$('mobileMenu')?.classList.add('hidden');if(which==='saved'){shell?.classList.add('hidden');savedView?.classList.remove('hidden');$('navSaved')?.classList.add('active');renderLibrary()}else{savedView?.classList.add('hidden');shell?.classList.remove('hidden');if(which==='account'){goSetupPage(0,true);$('navAccount')?.classList.add('active')}else{goSetupPage(currentUser?1:0,true);$('navCreate')?.classList.add('active')}}}
$('navCreate')?.addEventListener('click',()=>showProductSection('create'));$('navSaved')?.addEventListener('click',()=>showProductSection('saved'));$('navAccount')?.addEventListener('click',()=>showProductSection('account'));$('brandHome')?.addEventListener('click',()=>exitStoryHome());$('topMenu')?.addEventListener('click',()=>$('mobileMenu')?.classList.toggle('hidden'));document.querySelectorAll('[data-mobile-nav]').forEach(b=>b.addEventListener('click',()=>showProductSection(b.dataset.mobileNav)));$('interests')?.addEventListener('input',updateIdeaCount);
initSupabase();
...
async function applyAuthSession(session){
 currentUser=session?.user||null;document.body.classList.toggle('moonbeam-signed-in',!!currentUser);
...
function renderProfileSelect(){
 ...
 const choices=$('profileChoices');if(choices){choices.innerHTML=cloudProfiles.map(p=>`<button type="button" class="profile-choice${p.id===activeProfileId?' active':''}" data-profile-id="${escapeHtml(p.id)}"><span class="profile-avatar">${escapeHtml((p.name||'?').slice(0,1).toUpperCase())}</span><span>${escapeHtml(p.name)}</span></button>`).join('')+`<button type="button" class="profile-choice new-profile${!activeProfileId?' active':''}" data-profile-id=""><span class="profile-avatar">＋</span><span>${escapeHtml(t().newChild)}</span></button>`;choices.querySelectorAll('[data-profile-id]').forEach(b=>b.onclick=async()=>{sel.value=b.dataset.profileId;await selectCloudProfile();renderProfileSelect()})}
}
...
async function deleteChildProfile(){
 if(!currentUser||!activeProfileId)return;const doomed=cloudProfiles.find(p=>p.id===activeProfileId);if(!confirm(t().deleteProfile(doomed?.name)))return;const oldPhotoKey=currentPhotoKey(activeProfileId);const {error}=await supabaseClient.from('child_profiles').delete().eq('id',activeProfileId);if(error){$('profileStatus').innerHTML=`<span class="error">${escapeHtml(error.message)}</span>`;return}await childPhotoDelete(oldPhotoKey);activeProfileId=null;await loadCloudProfiles();await selectCloudProfile();$('profileStatus').textContent=t().profileDeleted
}
...
function buildBook(s,image,child,options={}){const pages=Array.isArray(s.pages)?s.pages:[];const cacheId=makeStoryCacheId(s,child);return{title:s.title||t().title,opening:s.opening||'',character_bible:s.character_bible||'',pages,closing:s.closing||'',image:image||null,child,generationRunId:child?.generationRunId||null,storyId:Date.now()+'-'+Math.random().toString(36).slice(2),cacheId,visualCacheId:options.visualCacheId||cacheId,currentPage:-1,mobileSide:'text',readingMode:'self',isSaved:!!options.isSaved,isShared:!!options.isShared,shareToken:options.shareToken||null,shareSenderName:options.shareSenderName||'',savedAssets:options.savedAssets||{},savedStoryId:options.savedStoryId||null,savedAssetUrls:{},artwork:{cover:null,pages:{}}}}
function renderStory(s,image,child,options={}){
 ...
 if(storyExit)storyExit.addEventListener('click',e=>{e.preventDefault();e.stopImmediatePropagation();if(currentBook?.isShared){location.href='/'}else exitStoryHome()});
...
function renderBookPage(index){
 ...
 if(isEnd){
   const saveButton=`<button class="secondary end-save" id="endSave" type="button" ${book.isSaved?'disabled':''}>${escapeHtml(book.isSaved?(t().storySaved||t().savedBtn):t().save)}</button>`;
...
function renderLibrary(){
 ...
 l.innerHTML=`<div class="saved-story-list">${items.map((x,i)=>`<article class="saved-story-card"><div class="saved-story-main"><div class="saved-story-title">${escapeHtml(x.title)}</div><small>${escapeHtml(x.child?.name||'')}${x.language?` · ${escapeHtml(languageNames[x.language]||x.language)}`:''}</small></div><div class="saved-story-actions"><button class="primary saved-replay" type="button" onclick="openSaved(${i})">▶ ${escapeHtml(c.replay)}</button>${currentUser?`<button class="secondary saved-share" type="button" onclick="shareSavedStory(${i})">✉ ${escapeHtml((t().shareStory||'Share').replace(/^✉\s*/,''))}</button><button class="library-delete" type="button" onclick="deleteSavedStory('${escapeHtml(x.id)}')">🗑 ${escapeHtml(t().delete)}</button>`:''}</div></article>`).join('')}</div>`;
}
...
window.shareSavedStory=async i=>{const x=(currentUser?cloudStories:saved)[i];if(!x||!currentUser)return;const child={...(x.child||{}),language:x.language||language};delete child.referencePhoto;currentBook=buildBook(x.story,null,child,{isSaved:true,savedStoryId:x.id,visualCacheId:`saved:${x.id}`,savedAssets:x.savedAssets||{}});await openShareStory()};
...
const setupBrand=$('brandHome');
if(setupBrand){setupBrand.classList.add('setup-brand-home');setupBrand.setAttribute('title','Moonbeam Stories home');}
