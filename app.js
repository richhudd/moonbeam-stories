...
function renderStory(s,image,child,options={}){
 ...
 // V81: bind the cover choices directly as well as retaining delegated story clicks.
 // This makes entering the reader independent of any overlay/delegation interaction.
 const beginSelf=$('beginStory'),beginNarrated=$('beginNarrated');
 if(beginSelf)beginSelf.onclick=e=>{e.preventDefault();e.stopPropagation();beginStory('self')};
 if(beginNarrated)beginNarrated.onclick=e=>{e.preventDefault();e.stopPropagation();beginStory('narrated')};
