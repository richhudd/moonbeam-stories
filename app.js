...
'en-GB':{heroes:"Who’s this story about?",heroSub:'Choose one or more heroes',support:'Who else is coming along?',supportSub:'Choose any supporting characters — or leave this blank.',needHero:'Choose at least one hero.',age:a=>`Age ${a}`,breed:'Breed (optional)',idea:'e.g. Jack and Jill go camping with Tom. Jack and Jill are cousins. Tom is Jill’s daddy and Jack’s Uncle Tom…'},
'en-US':{heroes:"Who’s this story about?",heroSub:'Choose one or more heroes',support:'Who else is coming along?',supportSub:'Choose any supporting characters — or leave this blank.',needHero:'Choose at least one hero.',age:a=>`Age ${a}`,breed:'Breed (optional)',idea:'e.g. Jack and Jill go camping with Tom. Jack and Jill are cousins. Tom is Jill’s dad and Jack’s Uncle Tom…'},
'es-ES':{heroes:'¿De quién trata esta historia?',heroSub:'Elige uno o más protagonistas',support:'¿Quién más viene a la aventura?',supportSub:'Elige personajes secundarios o déjalo en blanco.',needHero:'Elige al menos un protagonista.',age:a=>`Edad ${a}`,breed:'Raza (opcional)',idea:'p. ej., Lucía y Mateo van de acampada con Carlos. Lucía y Mateo son primos. Carlos es el papá de Lucía y el tío Carlos de Mateo…'},
'es-419':{heroes:'¿De quién trata esta historia?',heroSub:'Elige uno o más protagonistas',support:'¿Quién más viene a la aventura?',supportSub:'Elige personajes secundarios o déjalo en blanco.',needHero:'Elige al menos un protagonista.',age:a=>`Edad ${a}`,breed:'Raza (opcional)',idea:'p. ej., Sofía y Mateo van de campamento con Carlos. Sofía y Mateo son primos. Carlos es el papá de Sofía y el tío Carlos de Mateo…'},
'fr-FR':{heroes:"De qui parle cette histoire ?",heroSub:'Choisissez un ou plusieurs héros',support:"Qui d’autre participe à l’aventure ?",supportSub:'Choisissez des personnages secondaires, ou laissez vide.',needHero:'Choisissez au moins un héros.',age:a=>`Âge ${a}`,breed:'Race (facultatif)',idea:'p. ex. Léa et Lucas partent camper avec Thomas. Léa et Lucas sont cousins. Thomas est le papa de Léa et l’oncle Thomas de Lucas…'},
'de-DE':{heroes:'Um wen geht es in dieser Geschichte?',heroSub:'Wähle eine oder mehrere Hauptfiguren',support:'Wer kommt noch mit?',supportSub:'Wähle Nebenfiguren aus – oder lass das Feld leer.',needHero:'Wähle mindestens eine Hauptfigur.',age:a=>`Alter ${a}`,breed:'Rasse (optional)',idea:'z. B. Emma und Lukas gehen mit Thomas zelten. Emma und Lukas sind Cousins. Thomas ist Emmas Papa und für Lukas Onkel Thomas…'},
'it-IT':{heroes:'Di chi parla questa storia?',heroSub:'Scegli uno o più protagonisti',support:'Chi altro viene con loro?',supportSub:'Scegli eventuali personaggi secondari oppure lascia vuoto.',needHero:'Scegli almeno un protagonista.',age:a=>`Età ${a}`,breed:'Razza (facoltativa)',idea:'es. Giulia e Luca vanno in campeggio con Marco. Giulia e Luca sono cugini. Marco è il papà di Giulia e lo zio Marco di Luca…'},
'pt-BR':{heroes:'Sobre quem é esta história?',heroSub:'Escolha um ou mais protagonistas',support:'Quem mais vai participar?',supportSub:'Escolha personagens de apoio ou deixe em branco.',needHero:'Escolha pelo menos um protagonista.',age:a=>`Idade ${a}`,breed:'Raça (opcional)',idea:'ex.: Ana e Lucas vão acampar com Paulo. Ana e Lucas são primos. Paulo é o pai da Ana e o tio Paulo do Lucas…'},
'pl-PL':{heroes:'O kim jest ta historia?',heroSub:'Wybierz jednego lub kilku głównych bohaterów',support:'Kto jeszcze bierze udział?',supportSub:'Wybierz postacie drugoplanowe albo pozostaw puste.',needHero:'Wybierz co najmniej jednego głównego bohatera.',age:a=>`Wiek ${a}`,breed:'Rasa (opcjonalnie)',idea:'np. Zosia i Jan jadą na biwak z Markiem. Zosia i Jan są kuzynami. Marek jest tatą Zosi i wujkiem Markiem dla Jana…'}
};
