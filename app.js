...
async function loadCurrentChildPhoto(){currentChildPhoto=activeProfileId?await childPhotoGetForProfile(activeProfileId):await childPhotoGet(currentPhotoKey());renderChildPhoto()}
