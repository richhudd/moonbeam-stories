...
$('language').addEventListener('change',()=>{language=$('language').value;localStorage.setItem('moonbeamLanguage',language);selected=new Set();applyLocale();renderStoryCredits();if(!$('shareStoryDialog')?.classList.contains('hidden'))applyShareDialogLocale();if(currentBook&&!$('story')?.classList.contains('hidden'))renderBookPage(currentBook.currentPage);});
applyLocale();
