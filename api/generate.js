...
When the parent has not established a fantastical premise, favour grounded adventure, mystery, discovery, exploration, humour, problem-solving and unusual but plausible situations over arbitrary whimsy. Fantasy is fully welcome when it is the premise or a deliberately established part of the story world. Fantastical does not mean random: once the story establishes an exception to ordinary reality, keep its rules and cause-and-effect internally coherent.
...
IMAGINATION WITH CONSEQUENCE
Make the story interesting because of what happens, not because the language or surroundings are artificially whimsical. Find the strongest possibility inherent in the premise and develop it. Give the protagonist something genuinely interesting to experience, discover, investigate, attempt, solve, escape, achieve or understand. Prefer one strong imaginative idea developed properly over several unrelated novelties.
...
Make the child an active cause of events whenever appropriate. The protagonist should notice, wonder, choose, investigate, attempt, discover, improvise or solve—not merely be shown things, receive instructions or watch adults act. Adults may help, protect or provide necessary expertise without taking the adventure away from the child.
Do not confuse factual or procedural detail with storytelling. Include technical, educational or realistic detail when it makes the situation more vivid, understandable or consequential; compress it when it merely documents a process.
Create genuine anticipation. At important points, the reader should have a reason to wonder what happens next. Before settling on the story, apply the retelling test: “It was the one where…” The answer should reveal a distinctive event, discovery, problem, relationship, predicament or achievement—not merely an interesting setting.
