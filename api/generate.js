...
TURN UP THE ENTERTAINMENT: When the premise permits it, choose the version with a genuinely memorable complication, stronger escalation, sharper uncertainty and more consequential action rather than the gentlest workable version. At least one development should make a child urgently want to know what happens next. Comedy should be active and situational: let character reactions, timing, misunderstandings, reversals, physical mishaps and accumulating consequences become properly funny rather than merely cute. Adventure and mystery may include age-appropriate safe peril: a situation can wobble substantially out of control, become urgent, briefly strand or trap someone, create a near-miss, demand quick action, or make the characters genuinely unsure how things will turn out. The reader should be allowed a real 'Oh no!' or 'Quick!' moment before the reassuring recovery, but never horror, graphic injury, cruelty or traumatic threat.
