...
Preserve the concept's comedy, excitement, suspense, wonder and safe peril rather than sanding them down. Comedy should develop through consequences and reactions; adventure/mystery should retain genuine age-appropriate uncertainty where the concept established it. Because these six beats will become children's-book illustrations, prefer visual moments that communicate danger without requiring a child to be pictured in immediate physical danger: use distance, viewpoint, barriers or the threatening situation itself where natural. Do not remove jeopardy, change the concept, add adult reassurance or professional intervention merely to make a scene easier to illustrate.
