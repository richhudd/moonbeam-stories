...
- Preserve genuine age-appropriate suspense from the plan. Do not soften an exciting sequence into procedural caution, adult supervision or explanation. Let urgent obstacles and uncertain moments feel immediate enough to be exciting while keeping the tone adventurous, child-appropriate and ultimately reassuring.\n- Ordinary objects and natural phenomena have no consciousness or agency unless the plan deliberately establishes fantasy. Avoid decorative personification and strained faux-poetic comparisons.\n- Do not manufacture a charming, profound or storybook sentence merely to decorate the prose. Prefer a clear, natural sentence that means something specific in the scene over a clever-sounding flourish.\n- Preserve exact supplied Cast names. Do not invent surnames, relatives, friends or recurring principal characters absent from the plan.\n- Produce one continuous coherent story of about 650-750 words across exactly SIX balanced reading spreads.\n- Spread 1 about 105-125 words; spreads 2-5 about 105-125 words each; spread 6 about 90-115 words.\n- No headings inside the prose.\n\nReturn JSON ONLY in exactly this shape:\n{"title":"string","opening":"spread 1 prose","pages":[{"text":"spread 2 prose"},{"text":"spread 3 prose"},{"text":"spread 4 prose"},{"text":"spread 5 prose"}],"closing":"spread 6 prose"}`;
    ...
    const ageProfiles = {
      '3-5': {
        label:'early-years',
        writing:'Use short, clear sentences, concrete language, simple cause-and-effect and frequent reassuring cues. Keep the central situation easy to understand. Excitement, wonder and fantasy are welcome when they arise from the premise. A brief urgent or uncertain moment is fine, but keep the overall experience warm, mild and quickly reassuring.',
      ...
      '6-8': {
        ...
        writing:'Use lively but accessible prose, clear motivations, strong cause-and-effect, humour and real suspense where natural. Adventure may include urgent obstacles, time pressure, uncertainty or a situation that requires quick thinking. Keep these moments non-graphic, suitable for the age and followed by a reassuring resolution.',
      ...
      '9-12': {
        label:'older-child',
        writing:'Use richer vocabulary, more layered motivations, stronger suspense, subtler humour and a more sophisticated story where natural, while remaining clearly suitable for a child. Urgent or uncertain situations can feel meaningful, but must not become graphic, horrific or adult in subject matter and should resolve reassuringly.',
...
Coherence must never become dullness. Plausibility is a constraint on imagination, not a substitute for imagination. A realistic story can contain extraordinary situations, discoveries, suspense, mystery, humour and surprise. A fantasy story can go far beyond ordinary reality, but its extraordinary elements should belong to the premise or established world and remain internally consistent.
...
DRAMATIC TENSION, NOT BLAND SAFETY: adventure and mystery may include age-appropriate urgency, uncertainty and meaningful obstacles. Something may go wrong, circumstances may change unexpectedly, time may matter, or the characters may need to think and act quickly. The reader should have genuine reasons to wonder what happens next. Keep the tone adventurous rather than frightening: no graphic harm, cruelty, traumatic situations or disturbing threats. Do not force tension into every story, but when the premise calls for suspense, do not neutralise it into harmless procedure. Resolve tense sequences reassuringly.
...
EXCITEMENT AND DRAMATIC TENSION: For adventure and mystery concepts, actively consider whether urgency, uncertainty, a meaningful obstacle, time pressure or an unexpected complication would make the idea more compelling. The reader should have a genuine reason to want to know what happens next. Keep the tension adventurous and suitable for the age: avoid graphic harm, cruelty, traumatic situations and disturbing threats, and end tense sequences reassuringly. Do not force tension when the chosen premise is compelling for another reason.
...
For adventure or mystery, preserve genuine dramatic tension in the chosen concept. Where appropriate to the age profile, let one or more scenes contain urgency, uncertainty, time pressure, an unexpected complication or a meaningful obstacle that requires action or ingenuity. Keep the tone adventurous rather than frightening, and ensure tense sequences resolve reassuringly.
