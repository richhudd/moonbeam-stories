...
- Preserve genuine age-appropriate suspense from the plan. Do not soften an exciting safe-peril sequence into procedural caution, adult supervision or explanation. Let danger feel immediate enough to be exciting while remaining non-graphic, child-safe and ultimately reassuring.\n- Ordinary objects and natural phenomena have no consciousness or agency unless the plan deliberately establishes fantasy. Avoid decorative personification and strained faux-poetic comparisons.\n- Do not manufacture a charming, profound or storybook sentence merely to decorate the prose. Prefer a clear, natural sentence that means something specific in the scene over a clever-sounding flourish.\n- Preserve exact supplied Cast names. Do not invent surnames, relatives, friends or recurring principal characters absent from the plan.\n- Produce one continuous coherent story of about 650-750 words across exactly SIX balanced reading spreads.\n- Spread 1 about 105-125 words; spreads 2-5 about 105-125 words each; spread 6 about 90-115 words.\n- No headings inside the prose.\n\nReturn JSON ONLY in exactly this shape:\n{"title":"string","opening":"spread 1 prose","pages":[{"text":"spread 2 prose"},{"text":"spread 3 prose"},{"text":"spread 4 prose"},{"text":"spread 5 prose"}],"closing":"spread 6 prose"}`;
    ...
    const ageProfiles = {
      '3-5': {
        label:'early-years',
        writing:'Use short, clear sentences, concrete language, simple cause-and-effect and frequent reassuring cues. Keep the central situation easy to understand. Excitement, wonder and fantasy are welcome when they arise from the premise. Tension may produce a brief safe "oh no!" moment, but frightening or threatening moments must be brief, mild and quickly reassuring.',
      ...
      '6-8': {
        ...
        writing:'Use lively but accessible prose, clear motivations, strong cause-and-effect, humour and real suspense where natural. Age-appropriate peril is welcome: the reader may briefly think "Oh no!", "Quick!" or "How will they get out of this?" Mild danger should come from situations rather than graphic harm, remain clearly child-safe, and resolve into reassurance.',
      ...
      '9-12': {
        label:'older-child',
        writing:'Use richer vocabulary, more layered motivations, stronger suspense, subtler humour and a more sophisticated story where natural, while remaining clearly suitable for a child. Peril can feel meaningful and genuinely uncertain, but must not become graphic, horrific or adult in subject matter and should resolve safely.',
...
SAFE PERIL, NOT BLAND SAFETY: excitement is allowed to include age-appropriate danger, urgency and jeopardy. A child reader may briefly feel “Oh no!”, “Quick!” or “How are they going to get out of this?” without being given nightmare material. Prefer situational peril—being temporarily lost, stuck or stranded; a closing route; approaching weather; rising water; a runaway but controllable object or vehicle; a time limit; a daring but child-safe rescue; an unexpected failure or obstacle—over violence, cruelty, injury or terrifying threats. Do not force danger into every story, but when adventure or mystery calls for suspense, do not neutralise it into harmless procedure. Resolve peril safely and reassuringly.
...
EXCITEMENT AND SAFE DANGER: For adventure and mystery concepts, actively consider whether age-appropriate jeopardy would make the idea more compelling. The reader should sometimes be able to think “Oh no!”, “Quick!” or “How will they get out of this?” without encountering nightmare material. Situational danger, urgency, getting temporarily lost/stuck/stranded, an approaching storm, rising water, a closing route, a runaway but controllable situation, a time limit, an unexpected failure or a child-safe rescue can create real suspense. Avoid graphic harm, cruelty, death, abduction, realistic weapons and terrifying menace. Danger must fit the age guidance above and end safely. Do not force peril when the chosen premise is compelling for another reason.
...
CONTEMPORARY AUTHENTICITY: Do not use stock children's-adventure shorthand merely to signal adventure. In particular, do NOT introduce a map, plan, chart or diagram as a generic clue/discovery mechanism unless the Parent Story Idea or the specific setting genuinely requires one. Likewise, backpacks, torches, keys, mysterious notes, boxes, snacks, picnics, badges, ribbons and similar props should appear only when the particular premise gives them a genuine reason to exist. Prefer discoveries caused by what characters observe, hear, attempt, decide or physically encounter. Contemporary children should behave plausibly for the setting unless the premise establishes otherwise.
...
For adventure or mystery, do not storyboard all risk out of the chosen concept. Where appropriate to the age profile, let one or more scenes contain genuine but child-safe urgency or peril so the reader can briefly wonder whether the characters will make it, escape, reach safety, prevent the consequence or solve the situation in time. Keep the threat situational and non-graphic, and ensure the eventual resolution is reassuring.
