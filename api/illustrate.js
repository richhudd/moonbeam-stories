...
- SCENE CAST IS AUTHORITATIVE: when the scene direction states which selected Cast members are physically present, include ONLY those selected Cast members. Do not add another Hero, adult, child or pet merely because that character exists in the book, appears in the character bible, or has a reference image elsewhere. A small scene should remain small; an ensemble scene may be large when the story genuinely calls for it.
